# Script used to obtain the datasets used by the authors of the paper. 
# It comes from their github repo : https://github.com/junyanz/pytorch-CycleGAN-and-pix2pix/blob/master/datasets/download_cyclegan_dataset.sh
FILE=$1
